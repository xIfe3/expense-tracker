...
export function ConfirmModal({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-slate-950/50 backdrop-blur-sm">
      <div className="animate-scale-in w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl mx-4">
        <div className="mb-4 flex items-start gap-4">
          <div className={`shrink-0 rounded-xl p-2.5 ${destructive ? 'bg-red-50' : 'bg-blue-50'}`}>
